...
const int nbins = 6;	
  ...
  TH1F *Hist_zn_rap= new TH1F("importance of kriteria of rap", "importance&level;level[GeV]; importance;", 161, 0,16.0);
...
//	while (level_centr<=1){   
	...
	*/
	...
	//берем область справа от уровня
